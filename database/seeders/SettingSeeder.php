...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Setting::updateOrCreate(
            ...
            [
                'value' => 'Savelberg retreat center Muringa Road, off Elgeyo Marakwet N, Nairobi',
                'created_at' => '2026-01-26 08:10:18',
                'updated_at' => '2026-01-30 09:09:27',
            ]
        );
...
You will learn Nairobi academy to master your leadership style and find new world-class group facilitation techniques that will bring out your leadership traits.',
        ...
        Setting::updateOrCreate(
            [
                'key' => 'home_breakthrough_coach_image_url',
            ],
            [
                'value' => '',
                'created_at' => '2026-01-30 09:09:27',
                'updated_at' => '2026-01-30 09:09:27',
            ]
        );
        ...
        Setting::updateOrCreate(
            [
                'key' => 'home_video_testimonial_image_url',
            ],
            [
                'value' => '',
                'created_at' => '2026-01-30 09:09:27',
